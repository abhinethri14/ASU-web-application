...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="background-color: cyan">
        ...
        <h1><u><a style="font-size:18px font-family: Calibri" href="index.aspx" runat="server">Service directory</a></u></h1>
    </div>
    ...
    <div style="background-color: #FAE5D3  ;" class="my_text">
        ...
        <br>
        <br>
        <h4>How the TA can test the services ? </h4>
        The TA can test the services by navigating to the respective pages from Member Page or he/she can test all the services listed with the links in the service directory. 
        <br /> The Service directory also includes test pages for the Local Components like Global.asax, DLL, XML manipulation, Cookies and Sessions and UserControl.
        <br>
        <br>
       ...
       <ol>
        ...
        <li><h4>Cookies and Sessions</h4></li>
